...
let sliderCirclesAmount: p5.Element

const circlesArray: Circle[] = []
let circlesAmount = 400
...
new p5((p: p5) => {
  ...
  p.setup = () => {
    ...
    sliderCirclesAmount = p.createSlider(2, 2000, circlesAmount, 1).mouseReleased(() => {
      console.log('mm')
      circlesAmount = sliderCirclesAmount.value() as number
